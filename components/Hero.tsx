  ...
  return (
    <section className="relative min-h-[95vh] bg-[#F4F4F0] text-gray-900 flex flex-col justify-center overflow-hidden pt-32 pb-16">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        >
          <path d="M-100,400 C200,600 400,-100 800,200 C1200,500 1400,100 1600,300" stroke="url(#paint0_linear)" strokeWidth="80" strokeLinecap="round" className="drop-shadow-2xl" />
          <path d="M-50,450 C250,650 450,-50 850,250 C1250,550 1450,150 1650,350" stroke="url(#paint1_linear)" strokeWidth="30" strokeLinecap="round" opacity="0.6" />
          <defs>
        ...
        <div className="grid lg:grid-cols-[1.3fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 pb-8">
            <h1 className="text-[4.5rem] sm:text-[6rem] lg:text-[8rem] font-extrabold leading-[0.85] tracking-tighter text-gray-900">
              ...
              <span className="text-transparent inline-block" style={{ WebkitTextStroke: '2px #111827' }}>
                moment.
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-8 pt-8">
              ...
              <Link href="/services" className="group flex items-center gap-3 text-sm font-bold uppercase tracking-widest text-white bg-blue-900 hover:bg-blue-800 transition-colors px-6 py-3 rounded-full">
                <span>Explore Services</span>
                <div className="w-6 h-6 flex items-center justify-center group-hover:translate-x-1 transition-all">

        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-12">
            ...
            <p className="text-xl text-gray-600 font-light max-w-md leading-relaxed">
              Whether you are looking for care for a loved one or interested in joining our team, we would love to hear from you. Reach out and we will get back to you promptly.
            </p>

            <div className="space-y-6 pt-8 border-t border-gray-200">
              <div>
                <p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-1">Phone</p>
                <p className="text-2xl font-serif text-gray-900">(443) 985-4004</p>
              </div>
              <div>
                <p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-1">Email</p>
                <p className="text-lg text-gray-700 font-light">[Email coming soon]</p>
              </div>
              <div>
                <p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-1">Location</p>
                <p className="text-lg text-gray-700 font-light">Baltimore, MD</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F4F4F0] p-10 sm:p-14 rounded-3xl">
            <form className="space-y-10">
              ...
              <div className="relative group">
                <input type="tel" id="phone" className="w-full bg-transparent border-b border-gray-300 py-3 text-gray-900 focus:outline-none focus:border-blue-900 transition-colors peer" placeholder=" " />
                <label htmlFor="phone" className="absolute left-0 top-3 text-gray-500 text-sm transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-blue-900 peer-focus:font-bold uppercase tracking-widest peer-valid:-top-4 peer-valid:text-xs">Phone Number</label>
              </div>
              ...
              <div className="relative group">
                ...
                <label htmlFor="message" className="absolute left-0 top-3 text-gray-500 text-sm transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-blue-900 peer-focus:font-bold uppercase tracking-widest peer-valid:-top-4 peer-valid:text-xs">How can we help you?</label>
              </div>

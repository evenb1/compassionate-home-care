...
const services = [
  {
    ...
    details: ['Social engagement and activities', 'Accompaniment to appointments', 'Light household conversation', 'Emotional support and presence'],
  },
  {
    num: '02',
    ...
    details: ['Bathing and grooming assistance', 'Dressing assistance', 'Oral hygiene support', 'Skincare and hygiene routines'],
  },
  {
    num: '03',
    ...
    details: ['Medication reminders and scheduling', 'Dosage tracking and monitoring', 'Coordination with healthcare providers', 'Medication log maintenance'],
  },
  {
    num: '04',
  ...
  },
  {
    ...
    details: ['Recovery plan coordination', 'Wound care and hygiene monitoring', 'Physical therapy exercise support', 'Nutrition and hydration assistance'],
  },
  {
    num: '06',
    ...
    details: ['Chronic condition management', 'Palliative and comfort care support', 'Coordination with medical teams', 'Family education and guidance'],
  },
];
    ...
    <main className="bg-white text-gray-900">
      ...
      <section className="py-24 bg-blue-950 text-white">
        <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-blue-100/70 font-light text-xl max-w-xl mx-auto">Reach out and we will help you find the right care plan for your loved one.</p>
